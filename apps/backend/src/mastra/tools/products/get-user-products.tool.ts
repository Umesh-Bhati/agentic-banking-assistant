...
export const getUserProductsTool = createTool({ id: 'get-user-products', description: 'Display supported financial products privately; return aliases for statement quotes.', inputSchema: z.object({}), execute: async (_params, { requestContext }: any) => {
